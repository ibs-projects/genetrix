...
namespace e_apurement.Models
{
    ...
    public class Dossier : IDelateCustom
    {
        ...
        public string[] GetEtapDossier(int? eta=null)
        {
            ...
            switch (tmp)
            {
                case null: return new string[] { "Brouillon", "cornflowerblue", "dossier au brouillon.", "" };
                case 0: return new string[] { "En attente d'envoie à l'agence", "cornflowerblue", "dossier au brouillon.", "" };
                case 1: return new string[] { "Dossiers reçus", "cornflowerblue", "dossier envoyé à l'angence ", "En attente référence douane" };
                case 2: return new string[] { "Dossiers en cours de traitement ", "darkgoldenrod", "dossier en cours de traitement agence.", "" };
                case 3: return new string[] { "Dossier envoyé à la ", "#653613", "Dossiers envoyé à la conformité", "Envoyé à la conformité" };
                case 4: return new string[] { "Dossier en cours de traitement ", "#653613", "dossier transferé à la conformité", "En cours d'analyse conformité" };
                case 5: return new string[] { "Dossier reçu ", "#9d4d14", "dossier envoyé au service transfert", "Envoyé au service transfert" };
                case 6: return new string[] { "Dossier en cours de traitement ", "blue", "Dossier en cours de traitement service transfert", "En cours de traitement service de transfert" };
                case 7: return new string[] { "Dossier à envoyer à la BEAC", "#ffd800", "dossier à envoyer à la BEAC.", "A envoyer à la BEAC" };
                case 8: return new string[] { "Dossiers transmis à la BEAC", "forestgreen", "dossiers en cours de traitement BEAC.", "En cours de traitement BEAC" };
                case 9: return new string[] { "Saisie en cours", "green", "saisie en cours.", "" };
                case 10: return new string[] { "Dossier accordé", "green", "Executé", "" };
                ...
                case -2: 
                case -1:
                    return new string[] { "dossier rejeté", "red", "dossier rejeté" };
                default:
                    return new string[] { "", "white", "" };
            }
        }

        public ICollection<StatutDossier> StatusDossiers { get; set; } = new List<StatutDossier>();
