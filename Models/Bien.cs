...
namespace genetrix.Models
{
    public class Bien : Dossier
    {
        ...
        public override NatureOperation NatureOperation { get => NatureOperation.Bien; }
        ...
        public override bool EtapeNumerisation
        {
            get {
                try
                {
                    if (base.EtapeNumerisation && Qte>0 && !string.IsNullOrEmpty(Unite))
                        return true;
                }
                catch (Exception)
                { }
        ...
        [Display(Name = "Mode de transport")]
        public string ModeTransport { get; set; }

        [Display(Name = "Type d'expedition :   ")]
        public string TypeExpedition { get; set; }

        [Display(Name = "Description des marchandises")]
        ...
        [Display(Name = "Code")]
        public string ImportateurCode { get; set; }

        [Display(Name = "Services Connexes aux biens")]
        public string ServiceConnexe { get; set; } 
        
        [Display(Name = "Bureau d'embarquement:")]
        public string BureauEmbarquement { get; set; }
...
<body style=""font-family:'Times New Roman', Times, serif; font-size:1.1em; font-weight:bold;margin-left:8mm;margin-right:8mm; "">
        ...
        <h2 style ='padding:10px;margin-bottom:3px;margin-top:3px;text-align:center;text-transform:uppercase;border:4px solid black' > Domiciliation d'importation (biens)</h2>
        <table id = 'table-domici' border='1'>
            ...
            <tr>
                <td>Quantité(Poinds net) :</td>
                <td class='td-data'>
                    <span>{this.Qte}</span>
                </td>
            </tr>
            <tr>
                <td>Bureau d'embarquement:</td>
                <td class='td-data'>
                    <span>{this.BureauEmbarquement}</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class='td-data'>
                    <span>{this.MontantCVToString}</span>
                </td>
            </tr>
...
<body>
    <div class='table-responsive' style='margin-left:8mm;margin-right:8mm;'>
        ...
        <h2 style='padding:10px;margin-bottom:3px;margin-top:3px;text-align:center;text-transform:uppercase;border:3px solid black'>Déclaration d'importation de biens</h2>
                ...
                <td colspan='2'>
                    <div class='form-group mb-3'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-4'>
                                <label class='control-label mt-2'>Obtention</label>
                                <div class='input-group'>
                                    <input type='text' class='form-control input-sel' name='Obtention' id='Obtention' value='{this.Obtention}' />
                                </div>
                            </div>
                            <div class='col-4'>
                                <label class='control-label mt-2'>Péremption</label>
                                <div class='input-group'>
                                    <input type='text' class='form-control input-sel' name='Peremption' id='Peremption' value='{this.Peremption}' />
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-6'>
                                <label class='control-label mt-2'>Code</label>
                                <div class='input-group'>
                                    <input type='text' class='form-control input-sel' name='ImportateurCode' id='ImportateurCode' value='{this.ImportateurCode}' />
                                </div>
                            </div>
                            <div class='col-6'>
            ...
            <tr>
                <td colspan='2'>
                    <div class='form-group mb-3'>
                        <div class='row'>
                            <div class='col-6'>
                                <label class='control-label mt-2'>Mode de transport</label>
                                <div class='input-group'>
                                    <input type='text' class='form-control input-sel' name='ModeTransport' id='ModeTransport' value='{this.ModeTransport}' />
                                </div>
                            </div>
                            <div class='col-6'>
                                <label class='control-label mt-2'>Type d'expedition :</label>
                                <div class='input-group'>
                                    <input type='text' class='form-control input-sel' name='TypeExpedition' id='TypeExpedition' value='{this.TypeExpedition}' />
                                </div>
                            </div>
            ...
            <tr>
                <td colspan='2'>
                    <div class='form-group mb-3'>
                        <div class='row'>
                            <div class='col-6'>
                                <label class='control-label mt-2'>Description des marchandises</label>
                                <input type='text' class='form-control input-sel' name='TermeVente' id='Description' value='{this.Description}' />
                            </div>
                            <div class='col-6'>
                                <label class='control-label mt-2'>Services Connexes aux biens</label>
                                <input type='text' class='form-control input-sel' name='ServiceConnexe' id='ServiceConnexe' value='{this.ServiceConnexe}' />
                            </div>
                ...
                <td colspan='2'>
                    <div class='form-group mb-3'>
                        <div style='display:flex'>
                            ...
                            <div style='flex:0.6;padding-right:3px;'>
                                <label class='control-label mt-2'>Quantité</label>
                                <input type='text' class='form-control input-sel' style='width:80%' name='Qte' id='Qte' value='{this.Qte}' />
                            </div>
                            <div style='flex:1;padding-right:3px;'>
                                <label class='control-label mt-2'>Unité</label>
                                <input type='text' class='form-control input-sel' style='width:80%' name='Unite' id='Unite' value='{this.Unite}' />
                            </div>
                    ...
                    <div class='row'>
                        <div class='col-8'>
                            <div class='input-group'>
                                ...
                                <input type='text' class='form-control input-sel' name='TaxeInsp' id='TaxeInsp' value='{this.TaxeInsp}' />
                            </div>
                        </div>
                    </div>
                    <div class='row'>
