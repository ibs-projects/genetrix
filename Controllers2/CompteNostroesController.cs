...
namespace genetrix.Controllers
{
    public class CompteNostroesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Numero,RIB,Libellé,IdDevise,IdCorrespondant")] CompteNostro compteNostro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,RIB,Numero,Libellé,IdDevise,IdCorrespondant")] CompteNostro compteNostro)
        {
            if (ModelState.IsValid)
            {
