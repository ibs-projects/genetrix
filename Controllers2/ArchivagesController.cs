...
namespace genetrix.Controllers
{
    public class ArchivagesController : Controller
    {
        ...
        public ActionResult Index(int idDossier = 0,int idFournisseur = 0
            ...
            string tablist = "box",string cat="",bool inp_dfx=false,bool inp_fp = false,bool inp_ref = false,string tri="")
        {
            ViewBag.vue = vue;
            ...
            else
            {
                ...
                clientVMs = null;
                //ViewBag.clients = db.Structures.Include("Clients").FirstOrDefault(s=>s.Id==idSite).Clients;
