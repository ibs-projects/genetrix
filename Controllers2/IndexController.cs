       ...
       /// <returns></returns>
        public ActionResult IndexBanque(string panel="",string acc="",string ges="",string struc="",string interf="",string port="",string page="",string navigation="")
        {
            ...
            else
            {
                try
                {
                    ...
                    model.infoDocBanque2(autre, banque, 7);
            ...
            {
                //ViewBag.dossiersApuremenst=dd.Where(d=>d.Eta)
            }
        ...
        public ActionResult Index(string st="")
        {
            ...
            try
            {
                ...
                //addres += !string.IsNullOrEmpty(cl.Email)?1:0;
        ...
        private void OnTimedEvent(Object source, ElapsedEventArgs e)
        {
            ...
            if (DateTime.Now.Hour >= HeureExecuteDebut && DateTime.Now.Hour< HeureExecuteFin)
            {
                ...
                ||d.NatureOperation==NatureOperation.Service && d.Date_Etape23.Value.Day<14)).ToList().GroupBy(d=>d.ClientId))
                {
        ...
        private void GenerateMiseEnDemeure(IGrouping<int, Dossier> dossiers)
        {
            if (dossiers!=null && dossiers.Count()>0)
            {
                ...
                using (MemoryStream stream = new System.IO.MemoryStream())
                {
                    ...
                    texts.Add("gesName", "Jean Pierre BILOLO");
                    texts.Add("agenceName", "Agence d'Akanda");
                    texts.Add("agenceAdresse", "Akanda");
                    texts.Add("gesTel", "074859632");
                    texts.Add("gesVille", "Libreville");
                    texts.Add("dateNow", DateTime.Now.ToString("dd/MM/yyyy"));

                    texts.Add("clientName", "OLAM");
                    texts.Add("clientAdresse", "Lalala");
                    texts.Add("clientVille", "Libreville");

                    texts.Add("mntTrans", "74000");
                    texts.Add("deviseTrans", "EUR");
                    texts.Add("fourniTrans", "Lauren Picho");
