...
namespace genetrix.Controllers
{
    public class XtraRolesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "EstBackOffice,Nom,NiveauDossier,IdStructure,NiveauDossier,VoirDossiersAutres,VoirUsersAutres,VoirClientAutres")] XtraRole xtraRole)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            { }
            var dd = VariablGlobales.GetUsersByBanque(banqueId, db, min, Session["role"].ToString());
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "EstBackOffice,RoleId,Nom,NiveauDossier,IdStructure,NiveauDossier,VoirDossiersAutres,VoirUsersAutres,VoirClientAutres")] XtraRole xtraRole)
        {
            if (ModelState.IsValid)
            {
