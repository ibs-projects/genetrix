...
namespace genetrix.Controllers
{
    public class NumCompteBeneficiairesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Cle,Adresse,NomBanque,CodeAgence,Numero,Nom,Pays,Ville,IdFournisseur")] NumCompteBeneficiaire numCompteBeneficiaire)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Cle,Adresse,NomBanque,CodeAgence,Numero,Nom,Pays,Ville,IdFournisseur")] NumCompteBeneficiaire numCompteBeneficiaire)
        {
            if (ModelState.IsValid)
            {
