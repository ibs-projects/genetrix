...
namespace genetrix.Controllers
{
    public class CompteBanqueCommercialesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "EstBackOff,EstGestionnaire,Id,EstAdmin,Nom,NomUtilisateur,Prenom,Sexe,Tel2,Tel1,Email,Structure,IdXRole,IdSite")] CompteBanqueCommerciale compteBanqueCommerciale)
        {
