...
namespace genetrix.Controllers
{
    public class CompteXAFsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "NumCompte,RIB,Libellé,Cle")] CompteXAF compteXAF)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Cle,NumCompte,RIB,Libellé,BanqueId")] CompteXAF compteXAF)
        {
            if (ModelState.IsValid)
            {
