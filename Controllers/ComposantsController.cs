...
namespace genetrix.Controllers
{
    public class ComposantsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "NumDiscontinue,NumeroMax,NumeroMin,Numero,EstActif,Description,Localistion,Type,IdGroupe,IdAction,IdGroupeDisposionAccueil,Recherche")] Composant composant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,NumDiscontinue,NumeroMin,NumeroMax,Numero,EstActif,Description,Localistion,Type,IdGroupe,IdAction,IdGroupeDisposionAccueil,Recherche")] Composant composant)
        {
            if (ModelState.IsValid)
            {
