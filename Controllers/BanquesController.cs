...
namespace genetrix.Controllers
{
    public class BanquesController : Controller
    {
        ...
        public ActionResult DataAssync()
        {
            ...
            try
            {
                banque.TempsPassageArchivage=banque.TempsPassageArchivage == null ?7: banque.TempsPassageArchivage = 7;
                banque.DureeArchivage = banque.DureeArchivage == null ?365: banque.DureeArchivage = 365;
                banque.DureeRappelMiseEnDemaure = banque.DureeRappelMiseEnDemaure == null ?2: banque.DureeRappelMiseEnDemaure = 2;
                banque.RelanceDossierEchu = banque.RelanceDossierEchu == null ?2: banque.RelanceDossierEchu = 2;
            }
            catch (Exception)
            {}
            return View(banque);
